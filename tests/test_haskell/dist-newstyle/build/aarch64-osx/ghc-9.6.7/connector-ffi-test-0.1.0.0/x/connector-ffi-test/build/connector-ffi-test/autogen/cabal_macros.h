...
/* package connector-ffi-test-0.1.0.0 */
#ifndef VERSION_connector_ffi_test
#define VERSION_connector_ffi_test "0.1.0.0"
#endif /* VERSION_connector_ffi_test */
#ifndef MIN_VERSION_connector_ffi_test
#define MIN_VERSION_connector_ffi_test(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_connector_ffi_test */
...
#define CURRENT_COMPONENT_ID "connector-ffi-test-0.1.0.0-inplace-connector-ffi-test"
